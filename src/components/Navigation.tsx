...
// Меню строится на основе переводов
export default function Navigation() {
  ...
  const menuItems = [
    { name: translations.navigation.home, href: '#hero', number: '01' },
    { name: translations.navigation.about, href: '#about', number: '02' },
    { name: translations.navigation.services, href: '#services', number: '03' },
    { name: translations.navigation.cases, href: '#cases', number: '04' },
    { name: translations.navigation.contact, href: '#contact', number: '05' }
  ];
